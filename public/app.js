...
function readyFn() {
  ...
  $.getJSON("/articles", function(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      var titleLine = $("<h5>").addClass("articleTitle");
      titleLine.attr("data-id", data[i]._id).html(data[i].rank + ". " + data[i].title);
      var linkLine = $("<a>").attr("href", CNET_URL + data[i].link).html("Link");
      var summaryLine = $("<div>").html(data[i].summary + " ");
